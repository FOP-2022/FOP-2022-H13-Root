...
public class TransformMFCtorInvokes implements ClassTransformer {
    @Override
    public String getName() {
        return "mf-ctor-invokes";
    }

    @Override
    public void transform(ClassReader reader, ClassWriter writer) {
        if ("h13/MainFrame".equals(reader.getClassName())) {
        ...
        private class MV extends MethodVisitor {
            ...
            public void visitInsn(int opcode) {
                if (opcode == Opcodes.RETURN) {
                    ...
                    super.visitMethodInsn(Opcodes.INVOKESTATIC, "h13/PCDReplacementTutor", "addMF",
                            "(Lh13/MainFrame;)V", false);
                }
